""" Validate values for the feature "cases" have correct schema
"""
...
def validate_schema_cases(group_col, group_values, df, feature, output_dict):
    """ Validate the schema for cases
