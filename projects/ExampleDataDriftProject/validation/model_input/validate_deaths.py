""" Validate values for the feature "deaths" have correct schema
"""
...
def validate_schema_deaths(group_col, group_values, df, feature, output_dict):
    """ Validate the schema for deaths
